...
public class InMemoryWorldDao implements WorldDao {
	...
	public InMemoryWorldDao() {
		countries = Collections.synchronizedMap(new HashMap<>());
		cities = Collections.synchronizedMap(new HashMap<>());
		createCountries();
		createCities1();
		createCities1000();
		createCities2000();
		...
		continents = Collections.synchronizedSet(new HashSet<>());
	...
	@Override
	public synchronized Country updateCountry(Country country) {
	...
	@Override
	public synchronized List<Country> findCountriesByContinent(String continent) {
	...
	@Override
	public synchronized City findCityById(int id) {
		return cities.get(id);
	}

	@Override
	public synchronized City removeCity(City city) {
		return cities.remove(city.getId());
	}

	@Override
	public synchronized City addCity(City city) {
	...
	@Override
	public synchronized City updateCity(City city) {
		if (cities.containsKey(city.getId()))
			return cities.put(city.getId(), city);
		return null;
	}
	...
	@Override
	public synchronized List<City> findCitiesByCountryCode(String countryCode) {
